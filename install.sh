#!/bin/sh
# warpgate-connect installer
# Usage: curl -fsSL https://raw.githubusercontent.com/Stax124/warpgate-connect/main/install.sh | sh
#        curl -fsSL ... | sh -s -- --local   # Install to ~/.local/bin (no sudo)
#
# Downloads the latest warpgate-connect release from GitHub and installs
...
# Shamefully stolen from https://github.com/AlexsJones/llmfit/blob/main/install.sh
